...
#' @examples
#' \dontrun{
#' denoised_df <- newWave_denoising(dge_file = "path/to/dge_data.rds",
...
#'
#' @export
newWave_denoising <- function(dge_file = NULL,
  ...
  # NewWave denosing
  newWave_denoised <- newWave_model(rawGeneExp_filtered,
                                     min_count = min_count,
                                     min_cells = min_cells,
                                     K = K,
                                     maxIters = maxIters,
